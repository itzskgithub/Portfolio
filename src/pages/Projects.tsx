  ...
  const projects = [
    {
      ...
      image: 'https://gamescrafters.berkeley.edu/site-legacy-archive-sp20/games.php?game=tictactoe',
    ...
    },
    {
      ...
      image: 'https://www.istockphoto.com/illustrations/stone-paper-scissors',
      technologies: ['HTML','CSS','JS'],
      category: 'frontend',
